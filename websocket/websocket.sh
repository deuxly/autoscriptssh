...
# Link Hosting Kalian
deuxly="raw.githubusercontent.com/deuxly/try/main/websocket"

# Getting Proxy Template
wget -q -O /usr/local/bin/ws-nontls https://${deuxly}/websocket.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-ovpn https://${deuxly}/ws-ovpn.py
...
[Unit]
Description=Python Proxy
Documentation=https://teknoiy.my.id
After=network.target nss-lookup.target
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-tls https://${deuxly}/ws-tls
